...
function PlayerController(player, playPauseBtn, stopBtn, rwdBtn, fwdBtn, timeLabel, player_img) {
  this.player = player;
  this.playPauseBtn = playPauseBtn, player_img;
...
function showDiv() {
  var myEl =document.getElementById('big_pic');
...
function showDivTwo() {
  var myEl =document.getElementById('big_pic_2');
  if (myEl.style.display === "none") {
    myEl.style.display = "block";
  } else {
    myEl.style.display = "none";
...
function showDivThree() {
  var myEl =document.getElementById('big_pic_3');
  if (myEl.style.display === "none") {
    myEl.style.display = "block";
  } else {
    myEl.style.display = "none";
...
function showDivFour() {
  var myEl =document.getElementById('big_pic_4');
  if (myEl.style.display === "none") {
    myEl.style.display = "block";
  } else {
    myEl.style.display = "none";
...
function showDivFive() {
  var myEl =document.getElementById('big_pic_5');
  if (myEl.style.display === "none") {
    myEl.style.display = "block";
  } else {
    myEl.style.display = "none";
